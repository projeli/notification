...
{
    public static void AddNotificationServiceOpenTelemetry(this IServiceCollection services, ILoggingBuilder loggingBuilder, IConfiguration configuration)
    {
        ...
        services.AddOpenTelemetry()
            .ConfigureResource(builder => builder.AddService("notification-service"))
            .WithMetrics(builder =>
            {
                builder
    ...
    public static void UseNotificationServiceOpenTelemetry(this WebApplication app)
    {
